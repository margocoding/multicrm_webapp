  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-[#111827]/90 backdrop-blur-xl border border-white/10 rounded-lg text-white hover:bg-white/10 transition-all"
      >
      ...
      <motion.aside
        ...
        className={`fixed left-0 top-0 h-full bg-[#111827]/95 backdrop-blur-xl border-r border-white/10 z-50 shadow-2xl lg:z-30 ${
          mobileOpen ? 'z-50' : ''
        }`}
      >
        ...
        <button
          onClick={() => setMobileOpen(false)}
          className="lg:hidden absolute top-4 right-4 p-2 hover:bg-white/10 rounded-lg transition-all"
        >
